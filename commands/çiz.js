...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const progressMessage = await message.channel.send('<a:loadc:1183689114118262794> Resim hazırlanıyor... %0');
        ...
        const interval = setInterval(() => {
            ...
            if (percent >= 100) {
                ...
                progressMessage.edit(`<:agla2:1117558014048739500> Resim hazırlandı... %${percent}`);

                // Gerçek cevabı al
                request(`https://hercai.onrender.com/v3/text2image?prompt=${encodedSoru}`, (err, resp, body) => {
                    try {
                ...
                progressMessage.edit(`<a:loadc:1183689114118262794> Resim hazırlanıyor... %${percent}`);
            }
